    ...
    public class StellarGeliath : ModNPC
    {
            ...
            if (NPC.scale > 0.1f) {
                for (int i = 0; i < 2; i++) {
                    CosmosMetaball.Particles.SpawnParticle<SmokeSplatterMetaball>(particle => {
                        ...
                        particle.Scale = new Vector2(Main.rand.NextFloat(2f, 6f) * (0.5f + NPC.scale * 0.5f));
                ...
                if (Main.rand.NextBool(15)) {
                    CalamityHunt.Particles.SpawnParticle<PrettySparkle>(particle => {
                        ...
                        particle.Scale = new Vector2(Main.rand.NextFloat(0.2f, 1.2f) * NPC.scale);
                ...
                if (Main.rand.NextBool(4)) {
                    ...
                    CalamityHunt.Particles.SpawnParticle<PrettySparkle>(particle => {
                        ...
                        particle.Scale = new Vector2(Main.rand.NextFloat(0.1f, 0.6f) * NPC.scale);
                        particle.Color = new Color(30, 15, 10, 0);
                    });
                }
            }
        ...
        public void StarSigns()
        {
            ...
            if (Time > 58 && Time < 70) {
                ...
                debrisCount += (int)DifficultyBasedValue(0, 1, 1, 4, 3);
        ...
        {
            int waitTime = (int)DifficultyBasedValue(110, 90, 70, 50);
            if (Time < 40) {
                ...
                if (Time > 40 + waitTime + 2) {
                    ...
                    int count = (int)DifficultyBasedValue(2, 2, 3, 6, 4);
                    ...
                    for (int i = 0; i < count; i++) {
                        ...
                        Projectile starbit = Projectile.NewProjectileDirect(NPC.GetSource_FromThis(), NPC.Center + starPosition, starVelocity, ModContent.ProjectileType<StellarGelatine>(), GetDamage(5), 0f);
        ...
        public override bool PreDraw(SpriteBatch spriteBatch, Vector2 screenPos, Color drawColor)
        {
            ...
            int cosStompWaitTime = (int)DifficultyBasedValue(100, 90, 80, 40);
