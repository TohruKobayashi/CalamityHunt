...
{
    public class SlimeShotRedirecting : ModProjectile
    {
        public override string Texture => "CalamityHunt/Assets/Textures/NPCs/Bosses/GoozmaBoss/Projectiles/SlimeShot";
        ...
        public override void AI()
        {
            ...
            Projectile.scale = (float)Math.Sqrt(Utils.GetLerpValue(-60, -45, Time, true) * Utils.GetLerpValue(0, 20, Projectile.timeLeft, true));
            ...
            if (Time < 0) {
                ...
                SoundEngine.PlaySound(AssetDirectory.Sounds.Goozma.Dart with { Volume = 0.66f, Pitch = 1.5f }, Projectile.Center);
                Projectile.velocity = Projectile.DirectionTo(Main.player[target].MountedCenter).SafeNormalize(Vector2.Zero) * 20;
            }
        ...
        {
            Microsoft.Xna.Framework.Graphics.Texture2D texture = TextureAssets.Projectile[ModContent.ProjectileType<SlimeShot>()].Value;
            ...
            Color bloomColor = (new GradientColor(SlimeUtils.GoozColors, 0.2f, 0.2f).ValueAt(Projectile.localAI[0]) * Utils.GetLerpValue(-60, -45, Time, true)) with { A = 0 };
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition, outlineFrame, new Color(200, 200, 200, 0) * Utils.GetLerpValue(-60, -45, Time, true), Projectile.rotation, outlineFrame.Size() * 0.5f, Projectile.scale * 1.1f * squishFactor, 0, 0);
            ...
            Main.EntitySpriteDraw(texture, Projectile.Center - Main.screenPosition, baseFrame, lightColor * Utils.GetLerpValue(-60, -45, Time, true), Projectile.rotation, baseFrame.Size() * 0.5f, Projectile.scale * squishFactor, 0, 0);
