...
namespace CalamityHunt.Content.Projectiles.Weapons.Magic
{
    public class CrystalGauntletBall : ModProjectile
    {
        ...
        private void SetMagicHands()
        {
            ...
            // bar origianlly had an alpha of 128. unsure of how to replicate this under the new system without editing the displaybar method, which im too lazy to do rn
            WeaponBar.DisplayBar(Color.SlateBlue, Color.Lerp(Color.MediumOrchid, Color.Turquoise, Utils.GetLerpValue(0.3f, 0.8f, Main.LocalPlayer.GetModPlayer<GoozmaWeaponsPlayer>().CrystalGauntletsCharge, true)), Main.LocalPlayer.GetModPlayer<GoozmaWeaponsPlayer>().CrystalGauntletsCharge);
        }
