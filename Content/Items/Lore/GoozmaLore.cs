    ...
    public class GoozmaLore : ModItem
    {
        ...
        public override void ModifyTooltips(List<TooltipLine> tooltips)
        {
            ...
            if (!Main.keyState.IsKeyDown(Microsoft.Xna.Framework.Input.Keys.LeftShift)) {
                if (line != null) {
                    line.Text = Language.GetOrRegister($"Mods.CalamityMod.Items.Lore.ShortTooltip").Value;
                }
            ...
            string tooltip = Language.GetOrRegister($"Mods.{nameof(CalamityHunt)}.Items.GoozmaLore.Lore").Value;
