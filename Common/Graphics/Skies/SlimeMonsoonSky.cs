...
public class SlimeMonsoonSky : CustomSky
{
    ...
    private List<MonsoonStrike>[] thunder;
    ...
    public override void Update(GameTime gameTime)
    {
        ...
        if (thunder == null) {
            thunder = new List<MonsoonStrike>[]
            {
                new List<MonsoonStrike>(),
                new List<MonsoonStrike>(),
                new List<MonsoonStrike>(),
            };
        }
    ...
    private class MonsoonStrike
    {
        public MonsoonStrike(Vector2 position, float strength, int time, int layer)
        {
