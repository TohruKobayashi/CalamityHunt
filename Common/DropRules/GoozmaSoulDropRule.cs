...
public class GoozmaSoulDropRule : IItemDropRuleCondition
{
    bool IItemDropRuleCondition.CanDrop(DropAttemptInfo info) => Main.player.Any(p => p.active && !p.GetModPlayer<AuricSoulPlayer>().goozmaSoul);
