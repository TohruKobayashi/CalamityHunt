...
public class PyrogenSoulDropRule : IItemDropRuleCondition
{
    bool IItemDropRuleCondition.CanDrop(DropAttemptInfo info) => Main.player.Any(p => p.active && !p.GetModPlayer<AuricSoulPlayer>().pyrogenSoul);
