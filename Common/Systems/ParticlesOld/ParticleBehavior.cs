...
public abstract class ParticleBehavior : ModTexturedType
{
    ...
    protected sealed override void Register()
    {
        ...
        Type = IDCount++;
        if (AssetDirectory.Textures.Particle2 is null)
            AssetDirectory.Textures.Particle2 = new Dictionary<int, Asset<Texture2D>>();
        AssetDirectory.Textures.Particle2.Add(Type, AssetUtilities.RequestImmediate<Texture2D>(Texture));
    }
